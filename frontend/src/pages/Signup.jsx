      ...
      <div className="hidden lg:flex flex-col justify-between w-[420px] shrink-0
        ...
        <div>
          <h1 className="text-3xl font-bold text-text-primary leading-snug mb-4 tracking-tight">
            Your AI co-pilot<br />for deep thinking.
          </h1>
          <p className="text-text-muted text-[15px] leading-relaxed max-w-xs">
            Join Asktronaut and start having clear, focused conversations with AI — built for productivity.
          </p>
        </div>
          ...
          {[...Array(5)].map((_, i) => (
            <span
              ...
              className={`block rounded-full ${
                i === 1 ? "w-2 h-2 bg-accent" : "w-1.5 h-1.5 bg-border-subtle"
              }`}
            />
          ))}
          <span className="text-text-muted text-xs ml-1">Create account</span>
        </div>
      </div>
        ...
        <div className="w-full max-w-sm">
          ...
          <div className="mb-8">
            ...
            <p className="text-text-muted text-sm">
              Get started with Asktronaut for free.
            </p>
          </div>
